...
def main() -> None:
    ...
    try:
        ...
        builder = ViajeStatBuilder(az, az_fms)
        ...
        if fecha_dt.date() == fecha_limite and ("no existe ics en azure" in str(e).lower() or "no se encontraron archivos de viajestat" in str(e).lower()):
    ...
    id_reporte_tail = logger_tail.get_id_reporte("Tabla ViajeStat", default_id=9)
