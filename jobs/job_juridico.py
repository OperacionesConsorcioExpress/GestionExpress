...
class TareasProgramadasJuridico:
        ...
        try:
            ...
            with GestionClausulas() as gestion:
                ...
                for clausula in clausulas:
                    ...
                    with gestion.connection.cursor() as cursor:
                    ...
                    for f in fechas_dinamicas:
                        ...
                        # Calcular el estado dinámicamente
                        estado = gestion.calcular_estado(
                    ...
                    if filas_gestion:
                        gestion.insertar_filas_gestion_nuevas(clausula['id'], filas_gestion)
    ...
    def sincronizar_estados_filas_gestion(self):
        ...
        try:
            ...
            with GestionClausulas() as gestion:
                ...
                filas_gestion = gestion.obtener_todas_filas_gestion()

                for fila in filas_gestion:
                    # Recalcular el estado usando la lógica existente
                    nuevo_estado = gestion.calcular_estado(
                        fila['fecha_entrega'],
                        fila['fecha_radicado'],
                        datetime.today().date()
                    )
                    ...
                    if nuevo_estado != fila['estado']:
                        gestion.actualizar_estado_fila(fila['id_gestion'], nuevo_estado)
    ...
    def tarea_semanal_incumplimientos(self):
        ...
        try:
            ...
            with GestionClausulas() as gestion:
                gestion.enviar_correos_incumplimiento() # Correos a los responsables
                gestion.enviar_correos_incumplimiento_direccion()  # Correo consolidado para Dirección Jurídica
