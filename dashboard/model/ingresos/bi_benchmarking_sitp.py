"""
bi_benchmarking_sitp.py
───────────────────────
Proveedor de datos para el dashboard "Benchmarking SITP" (Ingresos).
...
def consultar() -> dict:
    """
    Punto de entrada estandar consumido por GET /api/bi/ingresos/benchmarking_sitp
