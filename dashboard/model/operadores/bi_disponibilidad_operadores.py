"""
bi_disponibilidad_operadores.py
───────────────────────────────
Proveedor de datos para el dashboard "Disponibilidad de Operadores" (Operadores).
...
def consultar() -> dict:
    """
    Punto de entrada estandar consumido por GET /api/bi/operadores/disponibilidad_operadores
    ...
    return {
        "ok": True,
        "fuente": "disponibilidad_operadores",
        "datos": [],
    }
