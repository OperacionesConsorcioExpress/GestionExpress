"""
bi_kilometros_comercial.py
──────────────────────────
Proveedor de datos para el dashboard "Kilómetros Comercial" (Kilómetros).
...
def consultar() -> dict:
    """
    Punto de entrada estandar consumido por GET /api/bi/kilometros/kilometros_comercial
