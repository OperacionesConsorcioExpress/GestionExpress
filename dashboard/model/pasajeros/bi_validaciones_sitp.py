"""
bi_validaciones_sitp.py
───────────────────────
Proveedor de datos para el dashboard "Validaciones SITP" (Pasajeros).
...
def consultar() -> dict:
    """
    Punto de entrada estandar consumido por GET /api/bi/pasajeros/validaciones_sitp
